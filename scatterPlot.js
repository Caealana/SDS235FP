...
d3.csv("fake.csv", function(data){
  ...
  var circles = svg.selectAll('circle')
    ...
    .append('circle')
      ...
      .attr('stroke','black')
      .attr('stroke-width',1)
      .attr('fill',function (d) { return d3.interpolateRainbow(getColor(d['type'])) })
  ...
  function articleChange(){
      ...
      var xChoice = document.getElementById("xSelect");
      var yChoice = document.getElementById("ySelect");
      var xString = xChoice.options[xChoice.selectedIndex].text;
      var yString = yChoice.options[yChoice.selectedIndex].text;
